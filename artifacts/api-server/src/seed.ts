...
const SEED_DATA = [
  ...
  // Blue Raeven Farmstand: GPS verified — 20650 S Highway 99W, Amity OR 97101 (Yamhill County, south of Amity on 99W)
  { name: "Blue Raeven Farmstand", city: "Amity", note: "A genuine Yamhill County institution — the kind of roadside farm stand that earns its reputation over decades rather than Instagram campaigns. Blue Raeven grows its own fruit and bakes pies daily from what's ripe: Marionberry, peach, blueberry, apple, cherry. The jams and jellies are made from the same estate fruit. Open six days a week year-round. When you're driving between wineries on 99W and the pies are warm — stop. This is exactly what farm stand culture is supposed to look like.", category: "farmstand", lat: 45.098, lng: -123.201, website: "https://www.blueraevenfarmstand.com" },
  // Source Farms: GPS verified — 15713 Highway 47, Yamhill OR 97148 (Yamhill County, on Hwy 47 through Yamhill town)
  { name: "Source Farms", city: "Yamhill", note: "Tabula Rasa Farms and Kookoolan Farms joined forces here to build something genuinely unusual in a wine-country landscape dominated by grapes — a regenerative farm stand where sustainable seafood shares space with seasonal produce and artisanal pantry goods. The combination is not gimmicky: it reflects how Pacific Northwest chefs actually shop, sourcing land and sea from the same trusted network. Open Thursday through Monday year-round, which is rare for any farm operation in the valley. Worth the short detour off Hwy 47 north of McMinnville.", category: "farmstand", lat: 45.341, lng: -123.184, website: "https://www.sourcefarms.com" },
  // Draper Farms: GPS verified — 11105 SW Baker Creek Road, McMinnville OR 97128 (Yamhill County, SW of McMinnville)
  { name: "Draper Farms", city: "McMinnville", note: "The workhorse farm stand closest to downtown McMinnville — a big barn operation on Baker Creek Road with a CSA program and genuine seasonal range. The kind of place where you stop for sweet corn in August and come back for winter squash in October. Open daily dawn to dusk through the growing season. If you're in McMinnville for wine country and realize you want to cook something local for dinner, this is your first stop.", category: "farmstand", lat: 45.197, lng: -123.236, website: "https://www.drapersfarm.com" },
