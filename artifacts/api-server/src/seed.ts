...
const SEED_DATA = [
  ...
  { name: "West County Community Farm", note: "20-plus varieties of edible and cut flowers, 20-plus herb varieties, and seasonal produce from strawberries to pumpkins — all from a community-rooted West County operation. CSA memberships available.", category: "farmstand", lat: 38.3963, lng: -122.8430, website: "https://www.westcountycommunityfarm.com" },
  { name: "Mycopia Mushrooms", note: "The first company to commercially cultivate shiitake mushrooms in the US, still operating in Sebastopol. Maitake, trumpet royale, oyster, and clamshell varieties grown on-site. A serious stop for anyone who cooks.", category: "farmstand", lat: 38.3935, lng: -122.8741, website: "https://mycopia.com" },
  ...
  { name: "Alchemist Farm", note: "Sebastopol farm specializing in laying hens producing a variety of colored eggs — the kind of eggs that change how you think about eggs. Preorder chicks online and pick them up at the stand. Check the website for current location and hours.", category: "farmstand", lat: 38.4050, lng: -122.8380, website: "https://www.alchemistfarm.com" },
  { name: "Lao Saetern's Strawberry Stand", note: "A beloved wood shack on Highway 12 near Sebastopol — just-picked super-sweet strawberries and lines that prove it. Expect occasional one-basket-per-person rationing at peak season. A seasonal institution.", category: "farmstand", lat: 38.4000, lng: -122.8150, website: null },
  { name: "Kokopelli Farm", note: "U-pick blackberry farm in Sebastopol — great for summer picking. Check social media for current location and hours.", category: "farmstand", lat: 38.4020, lng: -122.8340, website: null },
];
