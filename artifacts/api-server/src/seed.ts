...
const SEED_DATA = [
  ...
  // ── WINERIES: YAMHILL-CARLTON ADDITIONS ──────────────────────────────────
  ...
  // Vincent Wine Company: GPS verified — small production, Ribbon Ridge appellation, Yamhill County
  { name: "Vincent Wine Company", city: "Newberg", note: "Owner-winemaker Vincent Fritzsche makes low-input, handmade Pinot Noir from sustainably-farmed Ribbon Ridge and Chehalem Mountains vineyards — and somehow keeps the prices human. Small production, direct sales, and the kind of accessible, craft-first approach that the valley's prestige tier can sometimes forget. A refreshing counterpoint worth seeking out.", category: "winery", lat: 45.3414, lng: -123.0071, website: "https://www.vincentwine.com" },

  // ── RESTAURANTS: DAYTON ──────────────────────────────────────────────────
  // The Bay House: GPS verified — relocated May 2025 to historic church, Dayton town square, OR 97114
  { name: "The Bay House", city: "Dayton", note: "After 45 years on the Oregon Coast, The Bay House relocated in May 2025 to a beautifully restored historic church in Dayton's town square — the move brought an extraordinary wine program (2,600 selections, one of Oregon's largest) and AAA Four Diamond cooking into the valley's most truffle-rich town. Four collaborating chefs. DiRōNA Award of Excellence 2024 and 2025. An unusual and seriously accomplished room.", category: "restaurant", lat: 45.2215, lng: -123.0671, website: "https://www.thebayhouse.org" },

  // ── RESTAURANTS: McMANNVILLE ─────────────────────────────────────────────
  // Humble Spirit: GPS verified — 606 NE 3rd St, McMinnville OR 97128
  { name: "Humble Spirit", city: "McMinnville", note: "Opened July 2022 with a clear point of view: pasture-raised beef and pork, handmade pasta, and a room that feels genuinely at ease with itself. No performance, no flourish — just precise, unfussy cooking that makes wine country evenings exactly what they should be. Quickly became the local favorite for after-tasting dinners on the way back through McMinnville.", category: "restaurant", lat: 45.2098, lng: -123.1973, website: "https://www.humblespiritmcminnville.com" },
  // Okta at Tributary Hotel: GPS verified — 351 NE Davis St, McMinnville OR 97128
  { name: "Okta", city: "McMinnville", note: "Tributary Hotel's intimate tasting menu restaurant draws from Willamette Valley micro-seasons and the hotel's own farm — Pacific seafood, estate vegetables, wines selected with real editorial intelligence. Four courses, serious sourcing, and one of the more thoughtful dinner experiences in McMinnville. Closed January through mid-April; plan accordingly.", category: "restaurant", lat: 45.2088, lng: -123.1960, website: "https://www.tributaryhotel.com/okta" },
  ...
  // Upriver Organics: GPS verified — McKenzie River corridor, Lane County OR (South Willamette Food Trail)
  { name: "Upriver Organics", city: "Vida", note: "U-pick blueberry farm and market along the McKenzie River east of Springfield — open May through December and one of the South Willamette Valley Food Trail's most loved destinations. If you're spending time in the Lane County end of the valley, this is the kind of stop that earns the drive.", category: "farmstand", lat: 44.1318, lng: -122.5981, website: null },
  // Fraga Farmstead Creamery: GPS verified — 24455 NW Gales Creek Rd, Forest Grove OR 97116 (Washington Co., Tualatin Valley edge)
  { name: "Fraga Farmstead Creamery", city: "Gales Creek", note: "Certified Animal Welfare Approved goat farm west of Forest Grove — hike with the goats, picnic by the pond, then pick up seasonal goat cheese, goat gelato, and goat-milk soaps at the farm stand. The kind of operation that exists because someone cared deeply about how animals live and what that does to flavor. Worth the detour from the main valley corridor.", category: "farmstand", lat: 45.5397, lng: -123.2972, website: "https://www.fragafarmstead.com" },

  // ── ARTISAN PRODUCERS ─────────────────────────────────────────────────────
  // Briar Rose Creamery: GPS verified — Worden Hill Rd, Dundee Hills OR 97115 (surrounded by Pinot vineyards)
  { name: "Briar Rose Creamery", city: "Dundee", note: "Cheesemaker Sarah Marcus works in a 120-square-foot tasting room nestled in the Dundee Hills above the valley — Pinot vineyards on every side, forest above. Seasonal, limited-edition cheeses designed specifically to pair with Oregon Pinot Noir: from spreadable Fromage Blanc to the aged Callisto. The chocolate truffles rolled in fromage blanc and cocoa are worth the trip on their own.", category: "producer", lat: 45.2931, lng: -123.0565, website: "https://www.briarrosecreamery.com" },
  // Willamette Valley Cheese Co.: GPS verified — Salem OR 97304
  { name: "Willamette Valley Cheese Co.", city: "Salem", note: "Family dairy heritage dating to 1962, with cheesemaking since 1999. Their raw-milk Gouda — distinct, complex, wine-friendly — appears regularly on winery tasting boards across the valley. Handcrafted Havarti and European-style rounds from Holstein dairy stock. A quiet, serious operation that feeds the region's cheese culture without fanfare.", category: "producer", lat: 44.9345, lng: -123.0398, website: "https://www.wvcheese.com" },
  // Fern's Edge Goat Dairy: GPS verified — Lowell OR 97452, Lane County (near Dexter Reservoir)
  { name: "Fern's Edge Goat Dairy", city: "Lowell", note: "A South Willamette goat operation near the covered bridges of Lane County. Their Mt. Zion — a hard, mild cheese — is exceptional and available at Lane County farmers markets. A quintessential slow-food producer: small scale, animal-focused, deeply rooted in where they live.", category: "producer", lat: 43.9145, lng: -122.7892, website: null },
  // Ochoa's Queseria: GPS verified — Albany OR 97321, mid-Willamette Valley
  { name: "Ochoa's Queseria", city: "Albany", note: "Family-run since 2005, named for the founder's father. Their hand-pulled Liliana's string cheese won Best String Cheese at the American Cheese Society in both 2023 and 2024 — back to back. The 9,000-square-foot operation in Albany is one of the Willamette Valley's most surprising artisan food stories. Watch the stretching process on weekdays.", category: "producer", lat: 44.6369, lng: -123.1050, website: null },
  // Marché Provisions: GPS verified — Eugene OR 97401, downtown (South Willamette anchor)
  { name: "Marché Provisions", city: "Eugene", note: "The gourmet anchor of Eugene's food scene — a treasure trove of artisan food and drink perfect for assembling a serious picnic before heading out on the South Willamette Valley Food Trail. Croque Madame and good coffee to start the day. A legitimate reason to stop in Eugene beyond the university.", category: "producer", lat: 44.0534, lng: -123.0925, website: "https://www.marcherestaurant.com/provisions" },

  // ── RESTAURANTS: SALEM (EOLA-AMITY HILLS) ────────────────────────────────
  ...
  // ── RESTAURANTS: McMANNVILLE 3RD STREET ──────────────────────────────────
  ...
  // ── RESTAURANTS: CORVALLIS (BENTON COUNTY / MID-VALLEY) ──────────────────
