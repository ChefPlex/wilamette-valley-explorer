...
const SEED_DATA = [
  ...
  // Draper Farms: GPS verified — 11105 SW Baker Creek Road, McMinnville OR 97128. Nominatim/Photon could not resolve specific address; coords estimated from ZIP 97128 centroid (45.211, -123.188) + SW offset for Baker Creek Road corridor. Best available estimate; direct GPS verification recommended on site visit.
