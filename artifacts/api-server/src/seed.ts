...
const SEED_DATA = [
  ...
  // Fraga Farmstead Creamery: GPS verified — 54655 NW Old Wilson River Rd, Gales Creek OR (Washington Co., Coast Range foothills)
  { name: "Fraga Farmstead Creamery", city: "Gales Creek", note: "The only certified organic goat dairy in Oregon — a family farm in the Gales Creek Valley, a tributary of the Tualatin River, just off Highway 6. Hike with the goats, picnic by the pond, and pick up seasonal goat cheese, goat gelato, and goat-milk soaps at the farm stand. The kind of operation that exists because someone cared deeply about how animals live and what that does to flavor. Worth the detour from the main valley corridor.", category: "farmstand", lat: 45.5397, lng: -123.2972, website: "https://www.fragafarmstead.com" },
