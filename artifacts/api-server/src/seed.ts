...
const SEED_DATA = [
  ...
  // Bergström Winery: GPS confirmed via Google Maps (45.2788159, -123.0276935) — tasting room, Newberg OR 97132. Previous coords (45.3264, -122.9430) were ~8.4km northeast of actual location.
  ...
  { name: "King Estate Winery Restaurant", city: "Eugene", note: "The on-site restaurant at King Estate sources heavily from the certified-organic estate farm — real farm-to-table, not decorative. The menu rotates with what's growing, the wines are poured by the estate team, and the views over the vineyard are worth the drive to the southern end of the valley.", category: "restaurant", lat: 43.86095, lng: -123.25068, website: "https://www.kingestate.com/visit/restaurant" },
  ...
  // Groundwork Organics: GPS confirmed via Google Maps (44.1426553, -123.1504508) — farm stand, Junction City OR 97448. Previous coords (44.2165, -123.2090) were ~8.7km north of actual location.
  { name: "Groundwork Organics", city: "Junction City", note: "Family-scale certified organic farm in the southern valley — and the farm where Antica Terra's chef Timothy Wastell occasionally works markets alongside the growers. That kind of chef-farmer relationship is exactly what makes the valley's ingredient sourcing so credible. Find them at farmers markets from Eugene to Portland throughout the season.", category: "farmstand", lat: 44.14266, lng: -123.15045, website: null },
  ...
  { name: "Blue Raeven Farmstand", city: "Amity", note: "A genuine Yamhill County institution — the kind of roadside farm stand that earns its reputation over decades rather than Instagram campaigns. Blue Raeven grows its own fruit and bakes pies daily from what's ripe: Marionberry, peach, blueberry, apple, cherry. The jams and jellies are made from the same estate fruit. Open six days a week year-round. When you're driving between wineries on 99W and the pies are warm — stop. This is exactly what farm stand culture is supposed to look like.", category: "farmstand", lat: 45.11038, lng: -123.20773, website: "https://www.blueraevenfarmstand.com" },
  // The Ground Market (formerly Source Farms): GPS at 15713 Highway 47, Yamhill OR 97148. Coordinates from prior Nominatim match (45.33025, -123.18394) — same physical location, pending Google Maps coordinate confirmation with new listing.
  { name: "The Ground Market", city: "Yamhill", note: "Tabula Rasa Farms and Kookoolan Farms joined forces here to build something genuinely unusual in a wine-country landscape dominated by grapes — a regenerative farm stand where sustainable seafood shares space with seasonal produce and artisanal pantry goods. The combination is not gimmicky: it reflects how Pacific Northwest chefs actually shop, sourcing land and sea from the same trusted network. Open Thursday through Monday year-round, which is rare for any farm operation in the valley. Worth the short detour off Hwy 47 north of McMinnville.", category: "farmstand", lat: 45.330, lng: -123.184, website: "https://www.thegroundmarket.com" },
